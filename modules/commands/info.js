...
module.exports = {
    ...
    data: 
        new SlashCommandBuilder()
            .setName('userinfo')
            .setDescription('Envoie les infos de compte discord')
            .addUserOption(opt =>
                opt.setName("Utilisateur")
                    .setDescription("Le profil Discord que vous voulez voir")
            ),
    ...
    run: function(intera) {
        ...
        intera.reply('test')
        .catch(error => console.log(utils.displayConsoleHour() + "Impossible d'envoyer userinfo dans le salon " + intera.channel.id + " (Serveur " + intera.guild.name + ")"))
