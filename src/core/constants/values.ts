...
import { CraftingItemSource, familiarData } from "./types";
...
export abstract class Constants {
    ...
    static readonly craftingItemData:Record<keyof typeof TranslationsCache.fr.others.gear.craftingItems, CraftingItemSource[]> = {
        ...
        aged_dragonglass: ["golem"],
        aged_leather: ["hunt"],
        amber: ["rocks"],
        ambergris_crystal: ["flipper"],
        ancient_bark: ["woods"],
        ancient_blueprints: ["mecha", "labyrith"],
        angelic_plume: ["morfalange"],
        armor_fragment: ["necrose"],
        aurichalcum: ["champion"],
        beast_antlers: ["bete"],
        beast_blood: ["bete"],
        beast_paw: ["bete"],
        bee_chrysalis: ["abeille"],
        black_oil: ["steampath"],
        blade_tip: ["serpent"],
        blazing_ember: ["ember_chest", "tycoon"],
        blood_sucker: ["sabrecroc", "labyrith"],
        blubber_oil: ["flipper"],
        brass_ring: ["gorzilla"],
        brass_spike: ["gorzilla"],
        buzzing_husk: ["abeille"],
        chipped_horn: ["noceros"],
        coal: ["veins"],
        copper_coil: ["rocks"],
        corrosive_toxin: ["larve", "labyrith"],
        corrupted_soul: ["faucheuse"],
        crackling_hide: ["noceros"],
        crimson_mane: ["champion"],
        crusty_horn: ["anoires"],
        crystal_silk: ["champion"],
        cursed_skull: ["faucheuse", "labyrith"],
        cursed_slab: ["cottrage"],
        decaying_bones: ["necrose"],
        devil_horn: ["drider"],
        drowned_echo: ["titan"],
        dune_core: ["serpent"],
        electric_horn: ["noceros"],
        feather: ["woods"],
        festive_bell: ["bete", "labyrith"],
        forbidden_tome: ["cottrage"],
        fossilized_egg: ["anoires"],
        fright_fabric: ["cottrage"],
        frostwing_claw: ["agivre"],
        frostwing_heart: ["agivre", "labyrith"],
        frostwing_horn: ["agivre"],
        frostwing_scale: ["agivre"],
        frozen_conch: ["flipper"],
        fur_pelt: ["field"],
        gargantuan_eye: ["gargantua", "labyrith"],
        gargantuan_fang: ["gargantua"],
        gargantuan_locks: ["gargantua"],
        gawrillas_rage: ["gorzilla"],
        ghostly_shroud: ["faucheuse"],
        glistening_pearl: ["titan", "tycoon"],
        glowing_eye: ["anoires", "labyrith"],
        glowing_halo: ["morfalange", "tycoon"],
        golden_tooth: ["golem"],
        gryphon_core: ["griffon", "labyrith"],
        gryphon_egg: ["griffon"],
        gryphon_quill: ["griffon"],
        heat_ore: ["hunt"],
        heat_pipe: ["steampath"],
        holy_silk: ["morfalange"],
        honey_jar: ["abeille"],
        hunters_flame: ["hunt"],
        iron_bolts: ["gargantua"],
        jade_orb: ["wyrm", "labyrith"],
        keystone: ["golem"],
        lava_mud: ["rocks"],
        lightning_vial: ["noceros", "labyrith"],
        linen: ["field"],
        logs: ["woods"],
        lunar_crest: ["serrulule"],
        lustrous_crystal: ["flipper"],
        lux_bracers: ["morfalange"],
        maggot_tail: ["larve"],
        maggot_teeth: ["larve"],
        mark_of_fury: ["gorzilla"],
        mega_barb: ["larve"],
        mega_eggsac: ["larve"],
        metal: ["veins"],
        metal_scraps: ["drider"],
        minerals: ["veins"],
        mutant_fungi: ["necrose"],
        mutated_brain: ["drider", "labyrith"],
        ocean_breeze: ["titan"],
        oily_spring: ["mecha"],
        platinum: ["rocks"],
        power_core: ["steampath"],
        prehistoric_hide: ["sabrecroc"],
        queen_venom: ["abeille", "tycoon", "labyrith"],
        refined_gunpowder: ["mecha"],
        ritual_mask: ["chaman"],
        rotten_blood: ["necrose"],
        royal_stinger: ["abeille"],
        rusted_chain: ["hunt"],
        rusty_horseshoe: ["mecha"],
        saber_tooth: ["sabrecroc"],
        sacred_gem: ["chaman"],
        savage_claw: ["sabrecroc"],
        scarlet_feather: ["serrulule"],
        slimy_scale: ["anoires"],
        smoldering_core: ["drider"],
        soul_candle: ["cottrage"],
        stuffed_doll: ["chaman", "tycoon"],
        submerged_alloy: ["titan"],
        tattooed_skin: ["gargantua"],
        terrorthorn_seed: ["epinator", "labyrith"],
        terrorvine: ["epinator"],
        terrorwing: ["epinator"],
        terror_pollen: ["epinator"],
        terror_teeth: ["epinator"],
        tough_scales: ["serpent"],
        toxic_fang: ["serpent"],
        tribal_drum: ["chaman"],
        veronicas_veil: ["champion"],
        vines: ["field"],
        weeping_wood: ["serrulule"],
        wild_fruit: ["serrulule"],
        wyrm_gut: ["wyrm"],
        wyrm_horn: ["wyrm"],
        wyrm_scales: ["wyrm"],
        wyrm_spine: ["wyrm"],
